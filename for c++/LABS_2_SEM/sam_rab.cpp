/*Рудович Александра, 1 курс пи фск, группа 14
	...
	если написать так, выдаёт ошибку компиляции error: no matching function for call to 'std::exception::exception(const char [])'|
...
void Number::Input()
{
    ...
    cin>>a;
    if (a<=0)
        throw exception("Uncorrect Number");
...
void Number::Input()
{
    ...
    cin>>a;
    if (a<=0)
        throw "Uncorrect number, (a) must be > 0";
